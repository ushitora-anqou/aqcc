...
./aqcc test_define.c testutil.c stdlib.c system.s -o _test_define_exe.o
[ $? -eq 0 ] || fail "./aqcc"
./_test_define_exe.o
[ $? -eq 0 ] || fail "./_test_define_exe.o"

gcc -E -P test.c -o _test.c
./aqcc _test.c testutil.c stdlib.c system.s -o _test_exe.o
[ $? -eq 0 ] || fail "./aqcc"
./_test_exe.o
[ $? -eq 0 ] || fail "./_test_exe.o"

./aqcc test_link.c test_link.s -o _test_exe.o
[ $? -eq 0 ] || fail "./aqcc"
./_test_exe.o
